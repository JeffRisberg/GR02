...
/**
 * The <i>ProductController</i> was based on scaffold code, now being changed for session 
 * management. It covers the classes Product, ProductAttribute, and ProductAttributeValue.
 * 
