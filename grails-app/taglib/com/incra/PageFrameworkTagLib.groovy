...
import com.incra.DisplayFilterPojo
...
class PageFrameworkTagLib {
	...
	def filterGrid = { attrs, body ->
		...
		out << '<div style="border: 1px solid #C0D9AF; font-weight: normal; font-size: 0.9em; margin-top: 0px; margin-bottom: 8px; padding-left: 5px; background: #C0D9AF;">'
