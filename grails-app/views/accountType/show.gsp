            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="accountType.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: accountTypeInstance, field: "id")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="accountType.description.label" default="Description" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: accountTypeInstance, field: "description")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="accountType.accounts.label" default="Accounts" /></td>
