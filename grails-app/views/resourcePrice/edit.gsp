    ...
    <body>
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${resourcePriceInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: resourcePriceInstance, field: 'validFromDate', 'errors')}">
                                    <g:jqDatePicker id="validFromDate" name="validFromDate" value="${resourcePriceInstance?.validFromDate}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: resourcePriceInstance, field: 'validToDate', 'errors')}">
                                    <g:jqDatePicker id="validToDate" name="validToDate" value="${resourcePriceInstance?.validToDate}" />
                                </td>
                            </tr>
