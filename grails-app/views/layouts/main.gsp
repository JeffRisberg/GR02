		...
		<div class="xj_before_content">
				...
				<div id="xn_bar_menu">
					...
					<div id="xn_bar_menu_more">
						<form id="xn_bar_menu_search" method="GET"
							action="http://ecocloud-sv.com/main/search/search">
							<fieldset>
					...
					<ul id="xn_bar_menu_tabs">
						<li>
							<a
								href="http://ecocloud-sv.com/profile/${session.pfSession.user?.userId}"
								id="xn_username">
								${session.pfSession.profile?.fullName}</a>
						</li>
						<li>
							<a id="xn_signout" href="http://ecocloud-sv.com/main/authorization/signOut">Sign Out</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="xg_theme" data-layout-pack="romeo">
				<div id="xg_themebody">
					...
					<div id="xg_head">
						<div id="xg_masthead">
							<h1 id="xg_sitename" class="xj_site_name">
								<a id="application_name_header_link" href="http://ecocloud-sv.com">
									<img
						...
						<div id="xg_navigation">
							<ul>
								<li id="xg_tab_main" class="xg_subtab">
									<a href="http://ecocloud-sv.com">
										<span>Home</span>
									</a>
								</li>
								<li class="xg_subtab">
									<a href="http://ecocloud-sv.com/page/contribute-content">
										<span>Community Content</span>
									</a>
								</li>
								<li class="xg_subtab">
									<a href="http://ecocloud-sv.com/page/topics-2">
										<span>Topics</span>
									</a>
								</li>
                  ...
                  <a href="http://ecocloud-sv.com/page/marketplace-and-personalized">
                    <span>Marketplace</span>
                  </a>
                </li>
								<li id="xg_tab_xn18" class="xg_subtab">
									<a href="http://ecocloud-sv.com/page/about-ecocloud">
										<span>About</span>
									</a>
								</li>
							</ul>
